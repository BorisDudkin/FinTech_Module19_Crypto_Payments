...
st.sidebar.write(f"The balance of the {account.address} address is ETH {get_balance(w3, account.address)}")
...
st.sidebar.write(f"{candidate} is to receive ETH {wage}")
